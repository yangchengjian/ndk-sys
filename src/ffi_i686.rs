...
extern "C" {
    pub fn AImageDecoder_setCrop(arg1: *mut AImageDecoder, crop: ARect) -> ::std::os::raw::c_int;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
extern "C" {
    pub fn AImageDecoder_getMinimumStride(arg1: *mut AImageDecoder) -> size_t;
}
extern "C" {
